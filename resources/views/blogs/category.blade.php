...
@section('meta_description', 'Browse blog posts in ' . $category->name . ' category')
...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            <div class="inline-flex items-center px-4 py-2 rounded-full bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-300 mb-4">
            ...
            <p class="text-lg text-gray-600 dark:text-gray-400">
                {{ $blogs->total() }} {{ Str::plural('post', $blogs->total()) }} in this category
            </p>
        </div>
                                ...
                                @foreach($categories as $cat)
                                    <li>
                                        <a href="{{ route('blog.category', $cat->slug) }}" 
                                           class="block px-3 py-2 rounded-md text-sm font-medium transition-colors {{ $cat->id == $category->id ? 'bg-primary/10 text-primary' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                                            {{ $cat->name }}
                                            <span class="text-gray-500 dark:text-gray-400 ml-2">({{ $cat->blogs_count }})</span>
                                        </a>
                                    </li>
                                @endforeach
                            </ul>
