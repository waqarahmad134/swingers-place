        ...
        <form action="{{ route(($routePrefix ?? 'admin') . '.blog.update', $blog) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    @if($blog->featured_image)
                        <div class="mb-2">
                            ...
                            <img src="{{ asset($blog->featured_image) }}" alt="Current Featured Image" class="max-w-xs rounded-md border border-gray-300 mb-2">
                        </div>
                    @endif
                    ...
                    <p class="mt-1 text-xs text-gray-500">Upload new image to replace current one (max 5MB, formats: jpeg, jpg, png, gif, webp)</p>
                ...
                <div>
                    ...
                    <select id="template" name="template" class="mt-1 block w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-gray-900 shadow-sm focus:border-primary focus:outline-none focus:ring-primary dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                        <option value="1" {{ old('template', $blog->template ?? 1) == 1 ? 'selected' : '' }}>Template 1 (Default)</option>
                        <option value="2" {{ old('template', $blog->template ?? 1) == 2 ? 'selected' : '' }}>Template 2</option>
                        <option value="3" {{ old('template', $blog->template ?? 1) == 3 ? 'selected' : '' }}>Template 3</option>
                    </select>
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 border-t pt-6 dark:border-gray-700">
                    ...
                    <div class="max-h-48 overflow-y-auto border border-gray-300 rounded-md p-3 dark:border-gray-600 dark:bg-gray-700">
                        @forelse($categories as $category)
                            <label class="flex items-center gap-2 py-1">
                                <input type="checkbox" name="categories[]" value="{{ $category->id }}" {{ in_array($category->id, old('categories', $blog->categories->pluck('id')->toArray())) ? 'checked' : '' }} class="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary">
                ...
                <div>
                    ...
                    <div class="max-h-48 overflow-y-auto border border-gray-300 rounded-md p-3 dark:border-gray-600 dark:bg-gray-700">
                        @forelse($tags as $tag)
                            <label class="flex items-center gap-2 py-1">
                                <input type="checkbox" name="tags[]" value="{{ $tag->id }}" {{ in_array($tag->id, old('tags', $blog->tags->pluck('id')->toArray())) ? 'checked' : '' }} class="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary">
            ...
            <div class="border-t pt-6 dark:border-gray-700">
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <input type="text" id="meta_title" name="meta_title" value="{{ old('meta_title', $blog->meta_title) }}" class="mt-1 block w-full rounded-md border border-gray-300 bg-light px-3 py-2 shadow-sm focus:border-primary focus:outline-none focus:ring-primary dark:border-gray-600 dark:bg-gray-700">
                    ...
                    <div>
                        ...
                        <textarea id="meta_description" name="meta_description" rows="2" class="mt-1 block w-full rounded-md border border-gray-300 bg-light px-3 py-2 shadow-sm focus:border-primary focus:outline-none focus:ring-primary dark:border-gray-600 dark:bg-gray-700">{{ old('meta_description', $blog->meta_description) }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="text" id="meta_keywords" name="meta_keywords" value="{{ old('meta_keywords', $blog->meta_keywords) }}" placeholder="keyword1, keyword2, keyword3" class="mt-1 block w-full rounded-md border border-gray-300 bg-light px-3 py-2 shadow-sm focus:border-primary focus:outline-none focus:ring-primary dark:border-gray-600 dark:bg-gray-700">
            ...
            <div class="border-t pt-6 dark:border-gray-700">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" id="og_title" name="og_title" value="{{ old('og_title', $blog->og_title) }}" class="mt-1 block w-full rounded-md border border-gray-300 bg-light px-3 py-2 shadow-sm focus:border-primary focus:outline-none focus:ring-primary dark:border-gray-600 dark:bg-gray-700">
                    ...
                    <div>
                        ...
                        @if($blog->og_image)
                            <div class="mb-2">
                                <p class="text-xs text-gray-500 mb-1">Current Image:</p>
                                <img src="{{ asset($blog->og_image) }}" alt="Current OG Image" class="max-w-xs rounded-md border border-gray-300 mb-2">
                            </div>
                        @endif
                        ...
                        <p class="mt-1 text-xs text-gray-500">Upload new OG image to replace current one (max 5MB)</p>
                ...
                <div class="mt-4">
                    ...
                    <textarea id="og_description" name="og_description" rows="2" class="mt-1 block w-full rounded-md border border-gray-300 bg-light px-3 py-2 shadow-sm focus:border-primary focus:outline-none focus:ring-primary dark:border-gray-600 dark:bg-gray-700">{{ old('og_description', $blog->og_description) }}</textarea>
            ...
            <div class="border-t pt-6 dark:border-gray-700">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" id="twitter_title" name="twitter_title" value="{{ old('twitter_title', $blog->twitter_title) }}" class="mt-1 block w-full rounded-md border border-gray-300 bg-light px-3 py-2 shadow-sm focus:border-primary focus:outline-none focus:ring-primary dark:border-gray-600 dark:bg-gray-700">
                    ...
                    <div>
                        ...
                        @if($blog->twitter_image)
                            <div class="mb-2">
                                <p class="text-xs text-gray-500 mb-1">Current Image:</p>
                                <img src="{{ asset($blog->twitter_image) }}" alt="Current Twitter Image" class="max-w-xs rounded-md border border-gray-300 mb-2">
                            </div>
                        @endif
                        ...
                        <p class="mt-1 text-xs text-gray-500">Upload new Twitter image to replace current one (max 5MB)</p>
                ...
                <div class="mt-4">
                    ...
                    <textarea id="twitter_description" name="twitter_description" rows="2" class="mt-1 block w-full rounded-md border border-gray-300 bg-light px-3 py-2 shadow-sm focus:border-primary focus:outline-none focus:ring-primary dark:border-gray-600 dark:bg-gray-700">{{ old('twitter_description', $blog->twitter_description) }}</textarea>
            ...
            <fieldset class="space-y-3 border-t pt-4 dark:border-gray-700">
                ...
                <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
                    ...
                    <label class="flex items-center gap-2">
                        <input type="checkbox" name="allow_indexing" value="1" {{ old('allow_indexing', $blog->allow_indexing ?? true) ? 'checked' : '' }} class="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary">
                        <span class="text-sm">Allow Search Engine Indexing</span>
                    </label>
                </div>
                <p class="text-xs text-gray-500 mt-2">Uncheck "Allow Search Engine Indexing" to add noindex meta tag</p>
            </fieldset>
