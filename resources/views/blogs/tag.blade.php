...
@section('meta_description', 'Browse blog posts tagged with ' . $tag->name)
...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            <div class="inline-flex items-center px-4 py-2 rounded-full bg-purple-100 dark:bg-purple-900/40 text-purple-800 dark:text-purple-300 mb-4">
            ...
            <p class="text-lg text-gray-600 dark:text-gray-400">
                {{ $blogs->total() }} {{ Str::plural('post', $blogs->total()) }} tagged with this tag
            </p>
        </div>
                            ...
                            <ul class="space-y-2">
                                <li>
                                    <a href="{{ route('blog.index') }}" 
                                       class="block px-3 py-2 rounded-md text-sm font-medium transition-colors text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                                        All Posts
                                    </a>
                                </li>
                            ...
                            <div class="flex flex-wrap gap-2">
                                @foreach($tags->take(20) as $t)
                                    <a href="{{ route('blog.tag', $t->slug) }}" 
                                       class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium {{ $t->id == $tag->id ? 'bg-purple-200 dark:bg-purple-800 text-purple-900 dark:text-purple-100' : 'bg-purple-100 text-purple-800 hover:bg-purple-200 dark:bg-purple-900/40 dark:text-purple-300 dark:hover:bg-purple-900/60' }} transition-colors">
                                        {{ $t->name }}
                                        <span class="ml-1 text-purple-600 dark:text-purple-400">({{ $t->blogs_count }})</span>
                                    </a>
                                @endforeach
                            </div>
                        </div>
                ...
                @else
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-12 text-center border border-gray-200 dark:border-gray-700">
                        ...
                        <p class="text-gray-600 dark:text-gray-400 mb-4">
                            There are no blog posts with this tag yet.
                        </p>
                        <a href="{{ route('blog.index') }}" class="inline-flex items-center px-4 py-2 bg-primary text-white rounded-lg hover:bg-secondary transition-colors">
