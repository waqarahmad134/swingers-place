...
@section('title', 'Create Tag - Admin Panel')
...
@section('content')
    ...
    <h1 class="mb-6 text-3xl font-extrabold text-secondary">Create New Tag</h1>

    <div class="max-w-2xl rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <form action="{{ route(($routePrefix ?? 'admin') . '.tags.store') }}" method="POST" class="space-y-6">
            @csrf
