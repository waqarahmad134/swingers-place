            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-8 md:p-10 border border-gray-100 dark:border-gray-700">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-500 dark:text-gray-400 text-sm">
                        Choose account type for: <strong>{{ $user->name ?? $user->username ?? 'User' }}</strong>
                    </p>
                </div>

                <!-- Form -->
                <form method="POST" action="{{ route('admin.users.onboarding.profile-type.store') }}" class="space-y-4">
                    @csrf
