    ...
    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm text-gray-900 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100">
        <form action="{{ route('admin.slides.update', $slide) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" id="title" name="title" value="{{ old('title', $slide->title) }}" required class="mt-1 block w-full rounded-md border border-gray-300 bg-white px-3 py-2 shadow-sm focus:border-primary focus:outline-none focus:ring-primary dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                @error('title')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
            </div>

            <div>
                <label for="tagline" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Tagline</label>
                <input type="text" id="tagline" name="tagline" value="{{ old('tagline', $slide->tagline) }}" placeholder="e.g., Fresh From The Kitchen" class="mt-1 block w-full rounded-md border border-gray-300 bg-white px-3 py-2 shadow-sm focus:border-primary focus:outline-none focus:ring-primary dark:border-gray-600 dark:bg-gray-700 dark:text-white">
            ...
            <div>
                ...
                <textarea id="subtitle" name="subtitle" rows="3" class="mt-1 block w-full rounded-md border border-gray-300 bg-white px-3 py-2 shadow-sm focus:border-primary focus:outline-none focus:ring-primary dark:border-gray-600 dark:bg-gray-700 dark:text-white">{{ old('subtitle', $slide->subtitle) }}</textarea>
            ...
            <div>
                ...
                @if($slide->image)
                    <div class="mb-2">
                        <img src="{{ asset('storage/' . $slide->image) }}" alt="{{ $slide->title }}" class="h-32 w-auto rounded border border-gray-200 dark:border-gray-700">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" id="button_label" name="button_label" value="{{ old('button_label', $slide->button_label) }}" class="mt-1 block w-full rounded-md border border-gray-300 bg-white px-3 py-2 shadow-sm focus:border-primary focus:outline-none focus:ring-primary dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                ...
                <div>
                    ...
                    <input type="text" id="button_url" name="button_url" value="{{ old('button_url', $slide->button_url) }}" placeholder="https://example.com or #" class="mt-1 block w-full rounded-md border border-gray-300 bg-white px-3 py-2 shadow-sm focus:border-primary focus:outline-none focus:ring-primary dark:border-gray-600 dark:bg-gray-700 dark:text-white">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                    ...
                    <input type="number" id="order" name="order" value="{{ old('order', $slide->order) }}" min="0" class="mt-1 block w-full rounded-md border border-gray-300 bg-white px-3 py-2 shadow-sm focus:border-primary focus:outline-none focus:ring-primary dark:border-gray-600 dark:bg-gray-700 dark:text-white">
