<div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        @if(isset($matchedProfiles) && $matchedProfiles && $matchedProfiles->count() > 0)
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <!-- Section Header -->
                <div class="mb-6">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-sm mt-1">Members who match your profile</p>
                </div>
